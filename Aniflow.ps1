...
en = @{
    ...
    SetAiGpu='GPU (0 = auto):'; SetTempDir='Temp folder for AI frames (empty = system temp):'
...
tr = @{
    ...
    SetAiGpu='GPU (0 = otomatik):'; SetTempDir='AI kareleri icin gecici klasor (bos = sistem TEMP):'
